        ...
        bottom: PreferredSize(
          ...
          child: Container(
            ...
            child: TabBar(
              ...
              tabs: const [
                Tab(icon: Icon(Icons.people, size: 24), text: 'Users'),
                Tab(icon: Icon(Icons.notifications_active, size: 24), text: 'Alerts'),
                Tab(icon: Icon(Icons.payment, size: 24), text: 'Payments'),
                Tab(icon: Icon(Icons.analytics, size: 24), text: 'Reports'),
              ],
            ),
          ),
        ),
                  ...
                  child: Column(
                    ...
                    children: [
                      const CircleAvatar(
                        ...
                        child: Icon(Icons.admin_panel_settings, size: 32, color: Colors.blue),
                      ),
